...
describe('controllers', function() {
  ...
  describe('shows', function() {
    ...
    describe('POST /', function() {
      ...
      it('should return 400 in case of no request', function(done) {
	  ...
	  it('should return 400 in case of invalid request datatypes', function(done) {
		var inValidReqJson = {
			"payload": [
				{
					"country": 123,
	   ...
	   it('should return 200 in case of valid json request', function(done) {
		var validReqJson = {
			"payload": [
				{
					"country": "UK",
        ...
        request(server)
          ...
          .end(function(err, res) {
			...
			//(response.payload).should.be.type('array');
            done();
          });
      });
